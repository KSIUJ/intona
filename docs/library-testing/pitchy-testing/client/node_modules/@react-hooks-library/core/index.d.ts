 ...
 */
declare function BreakPointHooks<BreakPoints extends Record<string, BreakPointValue>>(breakpoints: BreakPoints): {
    /**
...
type BreakPointHooksReturn = ReturnType<typeof BreakPointHooks>;
...
type ClickOutsideEvents = Pick<WindowEventMap, 'mousedown' | 'mouseup' | 'touchstart' | 'touchend' | 'pointerdown' | 'pointerup'>;
...
interface InferEventTarget<Events> {
    addEventListener(event: Events, fn?: EventListenerOrEventListenerObject | null, options?: boolean | AddEventListenerOptions): void;
    removeEventListener(event: Events, fn?: EventListenerOrEventListenerObject | null, options?: boolean | EventListenerOptions): void;
}
type WindowEventName = keyof WindowEventMap;
type DocumentEventName = keyof DocumentEventMap;
type GeneralEventListener<E = Event> = {
    (evt: E): void;
};
/**
 ...
 */
declare function useEventListener<E extends keyof WindowEventMap>(event: E, listener: (this: Window, ev: WindowEventMap[E]) => void, options?: boolean | AddEventListenerOptions): Fn;
/**
 * Register listener using addEventListener when mounting, and removeEventListener automatically when un-mounting.
 *
 * Returns a cleanup function manually if you want to remove the listener manually.
 ...
 * @returns Clean up function for manual cleanup
 */
declare function useEventListener<E extends keyof WindowEventMap>(target: Window, event: E, listener: (this: Window, ev: WindowEventMap[E]) => void, options?: boolean | AddEventListenerOptions): Fn;
/**
 * Register listener using addEventListener when mounting, and removeEventListener automatically when un-mounting.
 *
 * Returns a cleanup function manually if you want to remove the listener manually.
 ...
 * @returns Clean up function for manual cleanup
 */
declare function useEventListener<E extends keyof DocumentEventMap>(target: Document, event: E, listener: (this: Document, ev: DocumentEventMap[E]) => void, options?: boolean | AddEventListenerOptions): Fn;
/**
 * Register listener using addEventListener when mounting, and removeEventListener automatically when un-mounting.
 *
 * Returns a cleanup function manually if you want to remove the listener manually.
...
type MouseSource = 'mouse' | 'touch' | null;
/**
 *
